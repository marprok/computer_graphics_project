...
public:
	Skeleton();
    Skeleton(glm::vec3 position, int goal, float hand_start_rotation, std::vector<Tile> &road, GeometryNode** g_node, int health, float scaling_factor, float velocity, bool boss);
	~Skeleton();
